...
class SearchHandler extends AbstractSearchHandler
{
    ...
    public function searchForm($record = null)
    {
        ...
        if (is_object($ui)) {
            ...
            $params = [];
            $params['searchmode_title'] = $this->getLanguage()->text('search_mode', 'atk');
            $params['searchmode_and'] = '<input type="radio" name="atksearchmethod" class="atkradio" value="AND" checked>'.$this->getLanguage()->text('search_and', 'atk');
            $params['searchmode_or'] = '<input type="radio" name="atksearchmethod" class="atkradio" value="OR">'.$this->getLanguage()->text('search_or', 'atk');
