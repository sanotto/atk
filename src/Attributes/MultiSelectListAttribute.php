    ...
    public function _addLinks($fieldprefix)
    {
        if (count($this->m_values) > 4 && !Tools::hasFlag($this->m_flags, self::AF_NO_TOGGLELINKS)) {
            return '<div align="left">
                  [<a href="javascript:void(0)" onclick="profile_checkAll(\''.$fieldprefix.$this->fieldName().'\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('check_all').'</a> <a href="javascript:void(0)" onclick="profile_checkNone(\''.$fieldprefix.$this->fieldName().'\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('check_none').'</a> <a href="javascript:void(0)" onclick="profile_checkInvert(\''.$fieldprefix.$this->fieldName().'\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('invert_selection').'</a>]</div>';
        }
