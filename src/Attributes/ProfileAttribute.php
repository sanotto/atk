...
class ProfileAttribute extends Attribute
{
    ...
    public function edit($record, $fieldprefix, $mode)
    {
        ...
        $result = '<div align="right">
                  [<a href="javascript:void(0)" onclick="profile_checkAll(\''.$this->fieldName().'\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('check_all').'</a> | <a href="javascript:void(0)" onclick="profile_checkNone(\''.$this->fieldName().'\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('check_none').'</a> | <a href="javascript:void(0)" onclick="profile_checkInvert(\''.$this->fieldName().'\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('invert_selection').'</a>]</div>';
        ...
        foreach ($allActions as $section => $modules) {
            ...
            $result .= '  <div style="font-size: 80%; margin-top: 4px; margin-bottom: 4px" >
                  [<a  style="font-size: 100%" href="javascript:void(0)" onclick="profile_checkAllByValue(\''.$this->fieldName().'\',\''.$section.'.\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('check_all',
                    'atk').'</a> | <a  style="font-size: 100%" href="javascript:void(0)" onclick="profile_checkNoneByValue(\''.$this->fieldName().'\',\''.$section.'.\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('check_none',
                    'atk').'</a> | <a  style="font-size: 100%" href="javascript:void(0)" onclick="profile_checkInvertByValue(\''.$this->fieldName().'\',\''.$section.'.\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('invert_selection',
                    'atk').'</a>]';
            $result .= '  </div>';
            $result .= '  <br>';
