        ...
        if ($total_records > 0) {
            ...
            if (!$this->hasFlag(self::AF_MANYBOOL_NO_TOOLBAR)) {
                $result .= '<div align="left">
                      [<a href="javascript:void(0)" onclick="ATK.ProfileAttribute.profile_checkAll(\''.$this->getHtmlId($fieldprefix).'\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('check_all',
                        'atk').'</a> <a href="javascript:void(0)" onclick="ATK.ProfileAttribute.profile_checkNone(\''.$this->getHtmlId($fieldprefix).'\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('check_none',
                        'atk').'</a> <a href="javascript:void(0)" onclick="ATK.ProfileAttribute.profile_checkInvert(\''.$this->getHtmlId($fieldprefix).'\'); return false;">'.$this->getOwnerInstance()->getLanguage()->trans('invert_selection',
                        'atk').'</a>]</div>';
            }
